...
8. If doctor returns `assembly`, hand off with `campaigns-os next build --packet <packet>` and follow `next-campaigns-build`'s recommended build–review–repair–verification loop.
