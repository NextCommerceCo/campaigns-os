...
- Preserve or add promo-code inputs only when the source/template/user explicitly asks for one. Promo-code inputs should submit shopper-entered codes to SDK/API and let SDK/API reprice selectors, totals, and discount rows.
