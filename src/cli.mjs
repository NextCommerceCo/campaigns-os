...
Usage:
  ...
  Template-stock pages: a page declared out of source scope (manifest skip_reason, or CampaignSpec build_scope.mode "partial") is template stock — its assembly decision carries template_stock: true and the locked family, intake demands no design source for it, and materialising a stock page requires explicit per-page operator opt-in (docs/design-source-package.md "Template-stock pages").
