...
| Demo preview | Starter pages can be served for a visual walkthrough. | A real campaign configuration, replaced demo values, and the ordinary build and proof gates. Demo behavior is not live commerce proof. |
